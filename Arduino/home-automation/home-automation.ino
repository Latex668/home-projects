...
void setup(){
    ...
    for(int i=0; i<8; i++){
      pinMode(fuseInputs[i], INPUT_PULLUP);
    }
...
void sendJSON(String type, String number,String value) {
    String jsonString = "";
...
void readFuses(){
  fuseState[1] = digitalRead(fuseInputs[1]);
  sendJSON("fuse", String(1), String(fuseState[1]));
  Serial.println(fuseState[1]);
  delay(150);
