...
void loop()
{
	...
	tooru.draw(videodisplay, (millis() / 50) % 20, videodisplay.xres / 4, videodisplay.yres / 2);
	//"drawMix" uses the alpha channel
	tooru.drawMix(videodisplay, (millis() / 50) % 20, videodisplay.xres / 2, videodisplay.yres / 2);
	//"drawAdd" adds the color components of the back ground and the sprite
	tooru.drawAdd(videodisplay, (millis() / 50) % 20, videodisplay.xres * 3 / 4, videodisplay.yres / 2);
