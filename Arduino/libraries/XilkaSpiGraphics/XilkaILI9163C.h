...
class ILI9163C : public SpiGraphics
{
public:

	/*
	 * ESP8266 Hardware SPI w/Hardware CS:
	 *     ILI9163C(resetPin, dcPin, csPin = -1)
	 *
	 * Hardware SPI:
	 *     ILI9163C(resetPin, dcPin, csPin)
	 *
	 * Software SPI:
	 *     ILI9163C(resetPin, dcPin, csPin, new SpiSoftWriter(sclkPin, mosiPin))
	 *
	 ...
	 *
	 */
	ILI9163C(int8_t resetPin, int8_t dcPin, int8_t csPin, SpiSoftWriter *_spiSoft = 0);
