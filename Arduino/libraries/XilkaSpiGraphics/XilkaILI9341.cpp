...
ILI9341::ILI9341(int8_t resetPin
		, int8_t dcPin
		, int8_t csPin
		, SpiSoftWriter *spiSoft)
		/*
		 * 10 MHz determined from spec sheet page 230
		 * min SCL write cycle time of 100nS
		 * Not sure about the 24MHz, but Adafruit library
		 * is using it.
		 */
	: ILI934X(Dim(240, 320)
