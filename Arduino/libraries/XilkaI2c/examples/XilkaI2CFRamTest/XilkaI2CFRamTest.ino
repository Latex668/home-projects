...
/*
 * Connect SCL    to analog 5 (Adafruit FRAM breakout has internal pullup)
 * Connect SDA    to analog 4 (Adafruit FRAM breakout has internal pullup)
 * Connect VDD    to 3.3V or 5.0V (the processor native V)
 * Connect GROUND to common ground
 */

Xilka::I2CFRam storage;
...
void setup(void)
{
	...
	Wire.begin();
	Wire.setClock(Xilka::I2CFRam::MaxI2CSpeed);
